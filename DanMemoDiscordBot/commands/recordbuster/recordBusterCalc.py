...
async def run(client, ctx):
    ...
    for turn in range(0, 15):
        ...
        total_damage+=enemy.turnOrderCounters(turn, active_adv, memboost, counterRate, 0)
        ...
        for sorted_skills_counter in range(0,len(sorted_skills_priority_list)):
            ...
            if(not is_fast and not is_enemy_attacked):
                ...
                total_damage+=enemy.turnOrderCounters(turn, active_adv, memboost, counterRate, 1)
        ...
        total_damage+=enemy.turnOrderCounters(turn, active_adv, memboost, counterRate, 2)
