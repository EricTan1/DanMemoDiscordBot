...
previous_page = interactions.Button(
    style=interactions.ButtonStyle.PRIMARY, label=arrow_left, custom_id="previous_page"
)
next_page = interactions.Button(
    style=interactions.ButtonStyle.PRIMARY, label=arrow_right, custom_id="next_page"
)
to_start = interactions.Button(
    style=interactions.ButtonStyle.PRIMARY, label=rewind, custom_id="to_start"
)
to_end = interactions.Button(
    style=interactions.ButtonStyle.PRIMARY, label=forward, custom_id="to_end"
)
