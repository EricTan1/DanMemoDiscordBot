...
def clearSetField(temp_embed: interactions.Embed, data: List[list]) -> interactions.Embed:
    temp_embed.description = "Select a unit via the dropdown menu or switch pages with the buttons"
...
# --- Single unit page ---
async def singleUnit(client: WaitForClient, ctx: CommandContext, db: DBcontroller, assistadventurerid: str):
