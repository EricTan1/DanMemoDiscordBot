...
class AdventureC:
    def __init__(self, title: str, name: str, types: str, stars: int, limited: bool, ascended: bool, stats: dict, skills: dict):
        self._title = title
        self._name = name
        self._type = types
        self._stars = stars
...
class AssistC:
    def __init__(self, title: str, name: str, stars: int, limited: bool, stats: dict, skills: dict):
        self._title = title
        self._name = name
        self._stars = stars
        self._limited = limited
...
class InsertCharacter:
    ...
    def insertAdventurerDevelopmentSkillEffects(self, adventurerdevelopmentid, skilleffectList: list):
        ele_list = ['light', 'wind', 'fire', 'dark', 'ice', 'water', 'earth', 'thunder']
        # AdventurerSkillEffects SET UP
        for effects in skilleffectList:
            #Type+Element
    ...
    def getInsertAssistID(self, characterid: int, limited: int, stars: int, title: str) -> int:
        ret = -1
...
async def run(dbConfig: DBConfig, client: WaitForClient, ctx: CommandContext, sub_command: str, unit_file: interactions.Attachment):
    # permission checking
