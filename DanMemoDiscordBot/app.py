...
async def rbcalc(ctx):
    ...
    if(await hasAccess(ctx.message.author,[708002106245775410,698143969166622720,685046495988154373],[708008774140690473,825721805489700876,699277609816555580,708302206780309544,913489903671738440,685466436923162634,685472735996018699,619478476713361409,933110903484858409])):
        try:
