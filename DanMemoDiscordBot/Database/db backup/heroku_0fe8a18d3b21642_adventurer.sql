...
CREATE TABLE `adventurer` (
  `adventurerid` int(11) NOT NULL AUTO_INCREMENT,
  `characterid` int(11) NOT NULL,
  `typeid` int(11) NOT NULL,
  `limited` tinyint(4) NOT NULL,
  `ascended` tinyint(4) NOT NULL,
...
-- Dump completed on 2020-04-02 15:51:18
